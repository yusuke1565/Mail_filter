...
def calculate_p(test_w2f, pL, w2pw):  #calculate probability to judge mail
...
with open(file,"r") as file:
    for line in file:
        mailLen+=1
        test_L=kadai7_1.return_Label(line)
        test_w2f = {}
        test_w2f = countWord(line)

        L2p={}
        for L in L2pL.keys():
            L2p[L] = calculate_p(test_w2f, L2pL[L], L2w2pw[L])
